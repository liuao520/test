...
class GroundTruth(object):
    def __init__(self, config_params, batch_keypoints_info):
        ...
        self.batch_keypoints_list = batch_keypoints_info#self.__tensor2list(batch_keypoints_info)
    ...
    def get_ground_truth(self):
        ...
        # print("batch_images_tensor形状:",batch_images_tensor.shape)    # (batch_size, image_height, image_width, channels)
    ...
    def __generate_target(self, keypoints_3d, keypoints_3d_exist):
        ...
        # target_weight = tf.convert_to_t?ensor(target_weight, tf.dtypes.float32)
